        ...
        submenu: [
          {
            label: 'Erfahre mehr',
            click() {
              shell.openExternal('https://carsten-nichte.de/publications/applications/art.works/');
            },
          },
          {
            label: 'Dokumentation',
            click() {
              shell.openExternal(
                'https://carsten-nichte.de/docs/artworks-app-manual/',
              );
            },
          },
        ],
