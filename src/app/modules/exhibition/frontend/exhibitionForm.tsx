...
function ExhibitionForm() {
  ...
  const onFormFinish = (valuesForm: any) => {
    let ft: FormTool<Exhibition> = new FormTool();
  ...
  return (
    <div>
      ...
      >
        ...
        <Form.Item label="Datum Vernissage" name="date_vernissage">
          <Input />
        </Form.Item>
        <Form.Item label="Datum Finissage" name="date_finissage">
          <Input />
        </Form.Item>
