...
export interface PublicationI extends DocItentifiable_Rel {
  // System
...
export interface PublicationTypeI extends DocItentifiable_Rel {
  // System
  id: string; // _id: string;
  docType: DocType;
  docScope: string;
...
export interface PublicationWhatI extends DocItentifiable_Rel {
  // System
  id: string; // _id: string;
  docType: DocType;
  docScope: string;
